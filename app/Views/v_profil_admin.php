<div class="container mx-auto my-10 p-5">
    <div class="md:flex no-wrap md:-mx-2">
        ...
        <div class="w-full md:w-3/12 md:mx-2">
            ...
            <a href="<?php echo base_url('Cadmin/GestionFiche'); ?>" class="block w-full text-white text-sm font-semibold bg-blue-500 hover:bg-blue-600 focus:outline-none focus:shadow-outline focus:bg-blue-600 rounded-lg p-3 my-4">
                < Retour
                    </a>
        </div>
